    ...
    <main class="main">
               <div class="card-header">
                             ...
                             <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="nombre" placeholder="Enter Pais">
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        <div class="form-group">
                    ...
                    <div class="card-footer" align="center">
                        <button type="button" class="btn btn-sm btn-success" onclick="GrabarPais();"><i class="fa fa-dot-circle-o"></i> Grabar</button>
