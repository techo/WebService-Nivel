CREATE TABLE cargo (
   ...
   nombre VARCHAR(100) NOT NULL COLLATE utf8_general_ci COMMENT 'Nombre do Cargo',
  ...
  PRIMARY KEY (id)
) ENGINE=INNODB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='Table de Cargo'