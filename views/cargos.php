...
<body class="navbar-fixed sidebar-nav fixed-nav">
    ...
    <main class="main">
               <div class="card-header">
                        <strong>Registro de Cargo</strong> 
                    </div>
                             ...
                             <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="nombre" placeholder="Enter Cargo">
                                        </div>
                                    </div>
                                </div>
                             <div class="row">
                    ...
                    <div class="card-footer" align="center">
                        <button type="button" class="btn btn-sm btn-success" onclick="GrabarCargo();"><i class="fa fa-dot-circle-o"></i> Grabar</button>
                        <button type="button" class="btn btn-sm btn-danger" onclick="LimpiarCargo();"><i class="fa fa-ban"></i> Limpiar</button>
                    </div>
    </main>
