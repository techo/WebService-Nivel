    ...
    <main class="main">
               <div class="card-header">
                    ...
                    <div class="card-footer" align="center">
                        <button type="button" class="btn btn-sm btn-success"onclick="EditarArea(<?php echo($id);?>);"><i class="fa fa-dot-circle-o"></i> Grabar</button>
                        <button type="button" class="btn btn-sm btn-danger" onclick="SalirArea();"><i class="fa fa-ban"></i> Salir</button>
                    </div>
    </main>
